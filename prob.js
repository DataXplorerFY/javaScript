...
function exponentPower(base, exponent) {
    var result = Math.pow(base, exponent);
    return result;
}
var output = exponentPower(2, 4);
...
function vowels_Count(String) {
    ...
    for (var i = 0; i < String.length; i++) {
        var character = lowerCaseString[i];
...
var FinalResult = vowels_Count("Hey i am Farhan younas A passionate Data Scientist");
